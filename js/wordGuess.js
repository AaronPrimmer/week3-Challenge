...
document.addEventListener("DOMContentLoaded", function () {
  winOrLoseElement = document.getElementById("win-or-lose");
...
// Displays the letters guessed to the screen
function displayGuessedLetters() {
  lettersGuessedId.innerHTML = lettersGuessed.join(" ");
...
function checkLetter(letter) {
  ...
  if (
    displayWordArray.join("") == chosenWord.toUpperCase() &&
...
function endGame() {
  ...
  if (
    chosenWord.toUpperCase() === displayWordArray.join("") &&
    NumberOfGuessesLeft >= 0
  ) {
    winOrLoseElement.innerHTML = "You Won!";
  } else {
    winOrLoseElement.innerHTML = `Word Was: ${chosenWord.toUpperCase()}, Better Luck Next Time`;
  }
